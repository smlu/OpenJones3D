...
static void rdCache_AddDrawCall(rdPayload* pDrawCall, rdDrawCallSortBucket* pSortBucket)
{
    ...
    // allow negative extra light
    extraLight->red   = STDMATH_CLAMP(extraLight->red, -1.0f, 1.0f);
    extraLight->green = STDMATH_CLAMP(extraLight->green, -1.0f, 1.0f);
    extraLight->blue  = STDMATH_CLAMP(extraLight->blue, -1.0f, 1.0f);
